...
import { listApplications } from "../controllers/applicationControllers";
const router = express_1.default.Router();
router.post("/", (0, authMiddleware_1.authMiddleware)(["tenant"]), applicationControllers_1.createApplication);
router.put("/:id/status", (0, authMiddleware_1.authMiddleware)(["tenant"]), applicationControllers_1.updateApplicationStatus);

...
import { useGetApplicationsQuery } from "@/state/api-services/applicationApiService";
...
const Applications = () => {
    ...
    <div>
      ...
      <pre>
        {JSON.stringify(
          {
            userId: authUser?.cognitoInfo?.userId,
            userType: authUser?.userRole,  // hoặc userType nếu bạn dùng key này
          },
          null,
          2
        )}
  ...
  if (isError || !applications) return <div>Error fetching applicationsssssssssss</div>;
